...
该站点按用户主页仓库 `darkgreendkh/darkgreendkh.github.io` 部署，发布地址为 `https://darkgreendkh.github.io/`。推送至 `main` 后，`.github/workflows/deploy-pages.yml` 会测试、构建并发布 `build/client` 的静态页面。

在仓库 `Settings -> Pages` 中将发布源设置为 **GitHub Actions**。
